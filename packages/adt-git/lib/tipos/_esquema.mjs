...
export const GANCHO_DA_FORMA = Object.freeze({ source: 'createBody', xml: 'body', custom: 'deploy' });
...
export const ESQUEMA = Object.freeze({
  ...
  nomeacao:   { obrigatorio: false, tipo: 'object',  doc: '{ max, fonte } — tamanho máximo do nome (com namespace). `deploy` recusa antes da rede. `fonte` diz se foi medido ou vem de documentação.' },
  // ---- conhecimento medido ----
  ...
  body:       { obrigatorio: false, tipo: 'function', doc: '(name, pkg, description, def) → XML completo do objeto (a definição É o body). Obrigatório na forma xml.' },
 ...
 * @property {'source'|'xml'|'custom'} forma
 * @property {{ libKey: string, param: string }} [container]
 * @property {{ max: number, fonte: string }} [nomeacao]
