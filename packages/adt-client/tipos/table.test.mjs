// tipos/table.test.mjs — teste irmão de table.mjs: contrato comum + o XML PROVADO por spike, byte a byte.
...
import mod from './table.mjs';
import { testesComuns, N, P, D } from './_teste.mjs';

testesComuns(mod);

test('table: XML byte-idêntico ao snapshot do spike', () => {
