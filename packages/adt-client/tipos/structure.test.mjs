// tipos/structure.test.mjs — teste irmão de structure.mjs: contrato comum + o XML PROVADO por spike, byte a byte.
...
import mod from './structure.mjs';
import { testesComuns, N, P, D } from './_teste.mjs';

testesComuns(mod);

test('structure: XML byte-idêntico ao snapshot do spike', () => {
