// tipos/behaviorDefinition.test.mjs — teste irmão de behaviorDefinition.mjs: contrato comum + o XML PROVADO por spike, byte a byte.
...
import mod from './behaviorDefinition.mjs';
import { testesComuns, N, P, D } from './_teste.mjs';

testesComuns(mod);

test('behaviorDefinition: XML byte-idêntico ao snapshot do spike', () => {
